        ...
        <div class="perfil-header">
            ...
            <div class="info-perfil">
                ...
                <form action="editarPerfil.php" method="post">
                    <button type="submit" class="btn-editar-perfil">Editar perfil</button>
                </form>
                <form action="eliminarCuenta.php" method="get">
                    <button type="submit" class="btn-cerrar-cuenta">Cerrar cuenta</button>
                </form>
            </div>
